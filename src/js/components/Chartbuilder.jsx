...
var Chartbuilder = React.createClass({
	...
	_renderErrors: function() {
		...
		var errorArrMessage = this.state.errors.messages;

		if ( typeof this.props.validateMeta === 'function' ) {

			errorArrMessage = this.state.errors.messages.concat(this.props.validateMeta(this.state.metadata));
		}
